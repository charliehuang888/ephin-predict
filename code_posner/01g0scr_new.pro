...
FOR zraum=0.,tmn-1. DO BEGIN
 IF tg0(zraum) GT 0 THEN g0ges(zraum)=g0(zraum)/tg0(zraum)/59.95312
ENDFOR
name='/Users/aposner/Documents/Kiel_data/archived/hires/g0_n2002.asc'   ;*****
openw,unit,name,/variable,/get_lun
printf,unit,g0ges
print,'Check:'
print,'Max output: ',max(g0ges)
free_lun,unit
end
