...
;********************PHA-Daten********************************************
tmn=1440.*tage
gesp4=fltarr(tmn)&prop4=fltarr(tmn)&gesp8=fltarr(tmn)&prop8=fltarr(tmn)
gesp25=fltarr(tmn)&prop25=fltarr(tmn)&geshe8=fltarr(tmn)&helhe8=fltarr(tmn)
geshe25=fltarr(tmn)&helhe25=fltarr(tmn);&helh34=fltarr(tmn)
geshe4=fltarr(tmn)&helhe4=fltarr(tmn)&gese150=fltarr(tmn)&ele150=fltarr(tmn)
gese300=fltarr(tmn)&ele300=fltarr(tmn)&gese1300=fltarr(tmn)
ele1300=fltarr(tmn)
totpha=fltarr(tmn)
;********************open phx-files*****************************************
...
; print,'150 ',e150(zz),' 300 ',e300(zz)
ENDFOR
print,'proton max:',max(prop4)
name='/Users/aposner/Documents/Kiel_data/archived/hires/pha_stat_n2002.asc'   ;*****
openw,unit,name,/variable,/get_lun
printf,unit,yn,ele150,ele300,ele1300,prop4,prop8,prop25,helhe4,helhe8,helhe25,gese150,gese300,gese1300,gesp4,gesp8,gesp25,geshe4,geshe8,geshe25
free_lun,unit
print,'Check:'
print,'yn',max(yn)
...
print,'gese150',max(gese150)
print,'gese300',max(gese300)
print,'gese1300',max(gese1300)
print,'gesp4',max(gesp4)
print,'gesp8',max(gesp8)
print,'gesp25',max(gesp25)
print,'geshe4',max(geshe4)
print,'geshe8',max(geshe8)
print,'geshe25',max(geshe25)



name='/Users/aposner/Documents/Kiel_data/archived/hires/epherr_n2002.asc'   ;*****
openw,unit,name,/variable,/get_lun
